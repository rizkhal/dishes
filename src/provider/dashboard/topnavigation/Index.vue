      ...
      <div class="relative flex w-full items-center pl-1 sm:ml-0 sm:pr-2">
        ...
        <div class="container relative left-0 flex w-3/4">
          ...
          >
            ...
            <input
              type="text"
              class="block w-full rounded-2xl bg-gray-800 py-1.5 pl-10 pr-4 leading-normal text-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="Search"
            />
          </div>
        </div>
